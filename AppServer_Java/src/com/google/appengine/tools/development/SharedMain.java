...
public abstract class SharedMain {
   ...
   private List propertyOptions = null;

   protected List getSharedOptions() {
   ...
   protected void postServerActions(Map stringProperties) {
   ...
   protected void addPropertyOptionToProperties(Map properties) {
   ...
   private void setTimeZone(Map serviceProperties) {
   ...
   @VisibleForTesting
   static Map parsePropertiesList(List properties) {
